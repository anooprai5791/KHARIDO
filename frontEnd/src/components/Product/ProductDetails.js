...
//see use of loader(The time upto which details are not fully loaded,we are fetching Loader component(in Loader folder)->as we see loading on websites)
